...
class ChangePassForm(forms.Form):
    oldPassword = forms.CharField(label=(u'Old Password'),widget=forms.PasswordInput(render_value=False))
    newPassword= forms.CharField(label=(u'New Password'),widget=forms.PasswordInput(render_value=False))
