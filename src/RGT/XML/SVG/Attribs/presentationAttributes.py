...
class PresentationAttributes(BasicSvgAttribute):
    ...
    def setAligmentBaseline(self, data):
        allowedValues = ['auto', 'baseline', 'before-edge', 'text-before-edge', 'middle', 'central', 'after-edge',
    ...
    def setDisplay(self, data):
        allowedValues = ['inline', 'block', 'list-item', 'run-in', 'compact', 'marker', 'table', 'inline-table',
    ...
    def setDominantBaseline(self, data):
        allowedValues = ['auto', 'use-script', 'no-change', 'reset-size', 'ideographic', 'alphabetic', 'hanging',
    ...
    def setFontStretch(self, data):
        allowedValues = ['normal', 'wider', 'narrower', 'ultra-condensed', 'extra-condensed', 'condensed',
    ...
    def setPointerEvents(self, data):
        allowedValues = ['visiblePainted', 'visibleFill', 'visibleStroke', 'visible', 'painted', 'fill', 'stroke',
                         'all', 'none', 'inherit']
