...
class BaseStructuralNode(BasicSvgNode, GraphicalEventAttributes, PresentationAttributes, ClassAttribute,
                         StyleAttribute):
        ...
        if node != None:
            ...
            if value == 'false' or value == 'False':
                ...
                raise ValueParsingError(
                    'Could not parse the value of the ' + self.ATTRIBUTE_EXTERNALRESOURCESREQUIRE + ' attribute', value)
        return None