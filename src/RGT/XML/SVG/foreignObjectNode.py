...
class ForeignObjectNode(BasicSvgNode, ConditionalProcessingAttributes, GraphicalEventAttributes, PresentationAttributes,
                        ClassAttribute, StyleAttribute, PositionAttributes, SizeAttributes):
